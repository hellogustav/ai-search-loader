...
const NeonInfinityTracer: React.FC<Props> = ({
  size = 220,
  tailFraction = 0.42,
  speedMin = 55,
  speedMax = 180,
  ...
  useEffect(() => {
    ...
    const samples = 1200; // dense for smooth curvature & trail
    ...
    const step = 1.4;                         // draw step in path units
...
export default NeonInfinityTracer;
