...
const GlowAnimation: React.FC<GlowAnimationProps> = ({
  ...
  return (
    <div className={`glow-animation-container ${className}`} ref={containerRef}>
      <svg className="main-svg" width="220" height="220" viewBox="0 0 162 162" fill="none">
        <path
        ...
        <defs>
          <linearGradient id="paint0_linear_glow" x1="16.6745" y1="36.7675" x2="144.125" y2="35.7694" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FF9C26"/>
            <stop offset="1" stopColor="#F14575"/>
          </linearGradient>
          <linearGradient id="paint1_linear_glow" x1="70.5557" y1="142.185" x2="108.121" y2="51.7212" gradientUnits="userSpaceOnUse">
